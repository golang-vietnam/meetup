...
type Driver interface {
	Open(name string) (Conn, error) // Open returns a new connection to the database.
}
...
type Conn interface {
	...
	// Because the sql package maintains a free pool of connections and only calls Close
	// when there's a surplus of idle connections, it shouldn't be necessary for drivers
	// to do their own connection caching.
	Close() error
